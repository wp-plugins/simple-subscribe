...
/**
 * Exporter is the base class for exporters to specific file formats. See other
 * classes below.
 */
...
abstract class Exporter
{
    ...
    public function __construct($exportTo = "browser", $filename = "exportdata")
    {
		if(!in_array($exportTo, array('browser', 'string'))){
			throw new Exception("$exportTo is not a valid Exporter export type");
		}
...
/**
 * ExporterTSV - Exports to TSV (tab separated value) format.
 */

class ExporterTSV extends Exporter
{
...
/**
 * ExporterCSV - Exports to CSV (comma separated value) format.
 */
...
/**
 * ExporterExcel exports data into an XML format  (spreadsheetML) that can be
